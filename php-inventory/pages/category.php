...
<?php if ($canManage): ?>
    <div class="mb-6 flex justify-end">
        <button type="button" onclick="toggleCategoryModal('addModal', true)" class="flex items-center gap-2 rounded-md border border-black dark:border-gray-600 px-4 py-2 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-100">
...
<div class="overflow-hidden rounded-lg border border-black dark:border-gray-600">
    <div class="grid grid-cols-5 gap-4 border-b border-black dark:border-gray-600 bg-white dark:bg-gray-800 p-4 text-sm font-medium dark:text-gray-300">
        <div>NO.</div>
    ...
    <?php if ($categories === []): ?>
        <div class="p-4 text-center text-sm text-gray-500 dark:text-gray-400">No categories found.</div>
    <?php else: ?>
        <?php foreach ($categories as $category): ?>
            <?php $catIsActive = (bool) ($category['is_active'] ?? true); ?>
            <div class="grid grid-cols-5 items-center gap-4 border-b border-black dark:border-gray-600 p-4 text-sm last:border-b-0 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-100">
                ...
                <div class="flex gap-2">
                    <?php if ($canManage): ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <span class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">View Only</span>
                    <?php endif; ?>
                </div>
            </div>
        <?php endforeach; ?>
...
<?php if ($canManage): ?>
    <div id="addModal" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/50 p-4">
        <div class="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl dark:text-gray-100">
            ...
            <form method="POST" action="<?php echo h(app_url('pages/category.php')); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="category_name" required class="w-full rounded border dark:border-gray-600 px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100">
                </div>
                <div class="flex justify-end gap-2">
                    <button type="button" onclick="toggleCategoryModal('addModal', false)" class="rounded border dark:border-gray-600 px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700">Cancel</button>
                    <button type="submit" name="add_category" class="rounded bg-black dark:bg-gray-600 px-4 py-2 text-white hover:bg-gray-800 dark:hover:bg-gray-500">Add Category</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="editModal" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/50 p-4">
        <div class="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl dark:text-gray-100">
            ...
            <form method="POST" action="<?php echo h(app_url('pages/category.php')); ?>">
                ...
                <div class="mb-4">
                    <label class="mb-1 block text-sm font-medium">Category Name</label>
                    <input type="text" name="category_name" id="edit_category_name" required class="w-full rounded border dark:border-gray-600 px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-100">
                </div>
                <div class="mb-4 flex items-center gap-3 rounded border dark:border-gray-600 px-3 py-2">
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" onclick="toggleCategoryModal('editModal', false)" class="rounded border dark:border-gray-600 px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700">Cancel</button>
                    <button type="submit" name="edit_category" class="rounded bg-black dark:bg-gray-600 px-4 py-2 text-white hover:bg-gray-800 dark:hover:bg-gray-500">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="deleteModal" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/50 p-4">
        <div class="w-full max-w-sm rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl dark:text-gray-100">
            <div class="mb-4 flex items-start gap-3">
                ...
                <div>
                    <h3 class="text-base font-bold text-gray-900 dark:text-gray-100">Delete Category</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Are you sure you want to delete <strong id="deleteCategoryName"></strong>? This action cannot be undone.</p>
            ...
            <form method="POST" action="<?php echo h(app_url('pages/category.php')); ?>">
                ...
                <div class="flex justify-end gap-2 border-t dark:border-gray-600 pt-4">
                    <button type="button" onclick="toggleCategoryModal('deleteModal', false)" class="rounded border dark:border-gray-600 px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700">Cancel</button>
